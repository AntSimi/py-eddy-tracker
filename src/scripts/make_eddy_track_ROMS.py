...
if __name__ == '__main__':
    ...
    # Parameters used by CSS11 and KCCMC11 (Sec. 3.2) to ensure the slow
    # evolution of the eddies over time; they use min and max values of 0.25
    # and 2.5
    ...
    if 'sum_radii' in SEPARATION_METHOD:
        # Separation distance factor. Adjust according to number of days
        # between records
    ...
    if 'SLA' in DIAGNOSTIC_TYPE:
        with Dataset(SSHFILE) as nc:
            sshmean = nc.variables['zeta'][-1, grd.jp0:grd.jp1,
                                           grd.ip0:grd.ip1]
